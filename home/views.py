...
def analytics(request):
    ...
    totals = {
        'supplier_data': {
            'wafugaji_received_baridi': sum(float(record.get('supplier_data', {}).get('wafugaji_received_baridi', 0) or 0) for record in daily_records),
            'wafugaji_received_moto': sum(float(record.get('supplier_data', {}).get('wafugaji_received_moto', 0) or 0) for record in daily_records),
            'wafugaji_received_mgando': sum(float(record.get('supplier_data', {}).get('wafugaji_received_mgando', 0) or 0) for record in daily_records),
            'jikoni_received_baridi': sum(float(record.get('supplier_data', {}).get('jikoni_received_baridi', 0) or 0) for record in daily_records),
            'jikoni_received_moto': sum(float(record.get('supplier_data', {}).get('jikoni_received_moto', 0) or 0) for record in daily_records),
            'jikoni_received_mgando': sum(float(record.get('supplier_data', {}).get('jikoni_received_mgando', 0) or 0) for record in daily_records),
            'madukani_received_baridi': sum(float(record.get('supplier_data', {}).get('madukani_received_baridi', 0) or 0) for record in daily_records),
            'madukani_received_moto': sum(float(record.get('supplier_data', {}).get('madukani_received_moto', 0) or 0) for record in daily_records),
            'madukani_received_mgando': sum(float(record.get('supplier_data', {}).get('madukani_received_mgando', 0) or 0) for record in daily_records),
            'jikoni_transferred_baridi': sum(float(record.get('supplier_data', {}).get('jikoni_transferred_baridi', 0) or 0) for record in daily_records),
            'jikoni_transferred_moto': sum(float(record.get('supplier_data', {}).get('jikoni_transferred_moto', 0) or 0) for record in daily_records),
            'jikoni_transferred_mgando': sum(float(record.get('supplier_data', {}).get('jikoni_transferred_mgando', 0) or 0) for record in daily_records),
            'madukani_transferred_baridi': sum(float(record.get('supplier_data', {}).get('madukani_transferred_baridi', 0) or 0) for record in daily_records),
            'madukani_transferred_moto': sum(float(record.get('supplier_data', {}).get('madukani_transferred_moto', 0) or 0) for record in daily_records),
            'madukani_transferred_mgando': sum(float(record.get('supplier_data', {}).get('madukani_transferred_mgando', 0) or 0) for record in daily_records),
